...
export default function ProductItem({id, name, price, imgUrl,product, addToCart}: ProductItemProps){
    return(
        <>
            <div
                 className="group my-10 flex w-full max-w-xs flex-col overflow-hidden border border-gray-100 bg-white shadow-md">
                <a className="relative flex h-60 overflow-hidden" href={"/product/" + id}>
                ...
                <div className="mt-4 px-5 pb-5">
                    ...
                    <div className={'flex justify-between'}>
                        <a href={'/product/'+id} className="btn flex items-center justify-center bg-gray-900 px-2 py-1 text-sm text-white transition hover:bg-gray-700">
                            <IoEyeSharp/>
                            Voir le produit
                        </a>
